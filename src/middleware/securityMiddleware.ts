...
export const helmetMiddleware = helmet({
  // Content-Security-Policy: allow same-origin scripts/styles (SPA assets are same-origin)
  contentSecurityPolicy: {
    directives: {
      defaultSrc: ["'self'"],
      scriptSrc: ["'self'", "'unsafe-inline'"], // unsafe-inline needed for React hydration on some builds
